package ru.itis.dis205.lab2_10.config;
...
@EnableJpaRepositories("ru.itis.dis205.lab2_10.repository")
public class Config implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPersistenceUnitName("lab2_10");
        em.setPackagesToScan("ru.itis.dis205.lab2_10.model");
