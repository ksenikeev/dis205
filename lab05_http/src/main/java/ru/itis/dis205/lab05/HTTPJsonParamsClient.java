...
public class HTTPJsonParamsClient {

    // host          port       uri
    // itislabs.ru    80      /page
    // Параметры размещаются в теле запроса по принципу ключ1=значение1&ключ2=значение2
    // param1=value1&param2=value2
    public void send(String host, int port, String uri, String json) {
        ...
        try {
            ...
            // вычисляем размер
            int postContentLength = json.getBytes("utf8").length;
            String headerParamContentLength = "Content-Length: " + postContentLength + "\r\n";
            String headerParamContentType = "Content-Type: application/json\r\n";
